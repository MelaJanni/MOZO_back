...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    String callId = get(remoteMessage, "call_id", get(remoteMessage, "callId", ""));
    ...
    Log.d(TAG, "Notification shown (" + id + ") title=" + title + " callId=" + callId + " table=" + tableNumber + " type=" + type + " channel=" + channelId);
    }
