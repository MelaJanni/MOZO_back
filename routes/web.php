...
// RUTAS DE RECUPERACIÓN DE CONTRASEÑA WEB

// Mostrar formulario para solicitar reset de contraseña
Route::get('/reset-password', [PasswordResetWebController::class, 'showLinkRequestForm'])->name('password.request');

// Procesar solicitud de reset de contraseña
Route::post('/reset-password', [PasswordResetWebController::class, 'sendResetLinkEmail'])->name('password.email');

// Mostrar formulario de reset con token
Route::get('/password/reset/{token}', [PasswordResetWebController::class, 'showResetForm'])->name('password.reset');

// Procesar reset de contraseña
Route::post('/password/reset', [PasswordResetWebController::class, 'resetPassword'])->name('password.reset.submit');
